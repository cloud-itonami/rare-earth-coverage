...
(defn collection
  [name]
  (str "com.etzhayyim.rare-earth-coverage." name))

(def cell-specs {
  :get {:legacy-cell "com-etzhayyim-apps-rareEarth-coverage-get"
     :phase :event
  ...
  :listactors {:legacy-cell "com-etzhayyim-apps-rareEarth-coverage-listActors"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listactors")]
     :required-gates common-gates
     :trigger "manifest cell listactors"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listflows {:legacy-cell "com-etzhayyim-apps-rareEarth-coverage-listFlows"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listflows")]
     :required-gates common-gates
     :trigger "manifest cell listflows"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :coveragesnapshot {:legacy-cell "com-etzhayyim-apps-rareEarth-coverageSnapshot"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "coveragesnapshot")]
     :required-gates common-gates
     :trigger "manifest cell coveragesnapshot"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :actor {:legacy-cell "com-etzhayyim-apps-rareEarth-actor"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "actor")]
     :required-gates common-gates
     :trigger "manifest cell actor"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :flow {:legacy-cell "com-etzhayyim-apps-rareEarth-flow"
     :phase :event
     :murakumo-node "reuben"
